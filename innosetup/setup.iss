...
Name: "{group}\Telemetry update removal 0.3.4"; Filename: "{app}\telemetry-update-removal.exe"
...
Name: "{group}\Uninstall Telemetry update removal 0.3.4"; Filename: "{app}\unins000.exe"
; Desktopicon (if selected during install - default is unselected)
Name: "{commondesktop}\Telemetry update removal 0.3.4"; Filename: "{app}\telemetry-update-removal.exe"; Tasks: desktopicon
